...
{{site.data.var.im}} 1.1.1 (module version: inventory-composer-metapackage = 1.1.1)  is compatible with version 2.3.0 and 2.3.1 of {{site.data.var.ce}}, {{site.data.var.ee}}, and {{site.data.var.ece}}.
